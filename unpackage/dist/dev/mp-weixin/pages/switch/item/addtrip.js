...
const _sfc_main = {
  ...
  methods: {
    ...
    // API 
    async addtrip(val) {
      const { data: res } = await http_getinfo.arttripApi({
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.sr("uUpload", "4d22c1bb-6,4d22c1bb-5"),
    h: common_vendor.p({
      ["auto-upload"]: false,
      ["max-count"]: 3
    }),
    ...
    j: common_vendor.sr("form1", "4d22c1bb-0"),
    k: common_vendor.p({
      model: $data.form
    }),
    l: common_vendor.o((...args) => $options.submit && $options.submit(...args)),
    m: common_vendor.sr("utoast", "4d22c1bb-7")
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-4d22c1bb"], ["__file", "F:/单子/8.30门票预定/booking/pages/switch/item/addtrip.vue"]]);
