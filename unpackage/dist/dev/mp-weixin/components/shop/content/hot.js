...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getInfo = async () => {
      const { data: res } = await http_getinfo.getByTypeApi(1);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-4421669b"], ["__file", "F:/单子/8.30门票预定/booking/components/shop/content/hot.vue"]]);
