...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getInfo = async () => {
      const { data: res } = await http_getinfo.getByTypeApi(3);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-a0475426"], ["__file", "F:/单子/8.30门票预定/booking/components/shop/content/wear.vue"]]);
